  ...
  return (
    <div className=' py-16'>
        <div className='max-w-[1240px] m-auto px-2 py-16 w-full '>
            <div className='py-12'>
                <footer className="shadow-xl shadow-gray-400 rounded-xl bg-white dark:bg-gray-900">
                    <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                        <div className="md:flex md:justify-between">
                        <div className="mb-6 md:mb-0">
                            <a href="https://flowbite.com/" className="flex items-center">
                                <Image src="/../public/assets/logo 2.png" className="w-full h-full pb-15" alt="FlowBite Logo" width={100} height={25}/>
                                <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">CrisDev</span>
                            </a>
                        </div>
                        <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                            ...
                            <div>
                                ...
                                <ul className="text-gray-600 dark:text-gray-400 font-medium">
                                    <li className="mb-4">
                                        <a href="https://github.com/CristoferBV" className="hover:underline ">Github</a>
                                    </li>
                                    <li>
                    ...
                    <div className="sm:flex sm:items-center sm:justify-between">
                        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://github.com/CristoferBV" className="hover:underline">CrisDev™</a>. All Rights Reserved.
                        </span>
                        <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                            <a href="https://www.facebook.com/profile.php?id=100007388294886" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                            ...
                            <a href="https://github.com/CristoferBV" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
